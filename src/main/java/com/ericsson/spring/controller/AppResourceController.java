...
public class AppResourceController {
    ...
    public void exportToexcel(String filename,HttpServletRequest request,HttpServletResponse response) throws IOException 
	{
	 ...
	 public void  fetchCurrentMlStoneFilesWithStorage(@RequestParam String langType,@RequestParam String buildId, HttpServletResponse response) throws Exception  
	 {
		 try {
			List<StringBuilder> alsbl = appservice.fetchCurrentMlStoneFilesWithStorage(getUserName(),buildId);
